...
- (void)showMessage:(NSString *)message
    ...
    backgroundColor:(RCTUIColor *)backgroundColor
      dismissButton:(BOOL)dismissButton // [macOS]
{
...
- (void)showOfflineMessage
{
  ...
  RCTExecuteOnMainQueue(^{
    ...
    [weakSelf showMessage:message color:color backgroundColor:backgroundColor dismissButton:false];
  });
  // macOS]
}
...
- (void)showMessage:(NSString *)message
              color:(RCTUIColor *)color
    backgroundColor:(RCTUIColor *)backgroundColor
      dismissButton:(BOOL)dismissButton // [macOS] RCTUIColor
{
}
- (void)showMessage:(NSString *)message
